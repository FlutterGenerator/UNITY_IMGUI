...
#For Non-Aide Users: LOCAL_SRC_FILES := $(LOCAL_PATH)/StarDust/Dobby/libraries/$(TARGET_ARCH_ABI)/libdobby.a
...
LOCAL_CPPFLAGS += -Wno-error=c++11-narrowing -fpermissive -Wall -fexceptions -frtti -fexceptions
